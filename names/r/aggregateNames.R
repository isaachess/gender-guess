...
write.csv(topMaleNames, file="Documents/programming/gender-guess/names/finalMaleNames.csv", quote=FALSE, row.names=FALSE)
write.csv(topFemaleNames, file="Documents/programming/gender-guess/names/finalFemaleNames.csv", quote=FALSE, row.names=FALSE)
